...
from review.models import UserProfile,College,FileInfo,UserDetails
...
def view_review(request):
    ...
    if len(c) != 0:
        ...
        if(line is not None):
            name1 = name1.upper()
            return render_to_response('review/collreview.html',{'line':line, 'flag':flag, 'name':name1},RequestContext(request))
        else:
